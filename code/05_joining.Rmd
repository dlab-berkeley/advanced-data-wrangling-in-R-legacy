...
Using a simple toy example is great because it is easy to see how things work in that much narrrow context. 
...
`full_join()` keeps the observations from both tables. If they were unmatched, then NAs were recordered in one of the two tables.
